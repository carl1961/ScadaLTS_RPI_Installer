...
echo "Creating User scadalts..."
sleep 2 

sudo mysql -e "CREATE USER 'scadalts' IDENTIFIED BY 'scadalts';"
echo "Creating User scadalts..."
sleep 2 
echo "GRANT ALL PRIVILEGES to scadalts..."
sleep 2
mysql -e "GRANT ALL PRIVILEGES ON scadalts.* to 'scadalts'"
...
sleep 2
cd /home/pi/ScadaLTS_RPI_Installer
mkdir -p /opt/tomcat/apache-tomcat-7.0.96/webapps/ScadaLTS
unzip ScadaBR.war -d /opt/tomcat/apache-tomcat-7.0.96/webapps/ScadaLTS
